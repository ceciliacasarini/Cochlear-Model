function nl_cochlear_model_Cecilia_Casarini()

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This Matlab function represents a physical model of the cochlea inspired
% by the work of A.Moleti(2009). This model is nonlinear, but it can be
% turned into a linear model when alpha0=0.
...
save(sprintf('Casarini_C_nl_cochlear_model_N%d_f0%d_a%d.mat',N, f0, adB),'Y',...
